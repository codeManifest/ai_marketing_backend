...
export async function createForm(req, res) {
  ...
  try {
    ...
    return res.json({ success: true, form, message: "Custom form created successfully" });
  } catch (error) {
...
export async function updateForm(req, res) {
  ...
  try {
    ...
    return res.json({ success: true, form: updatedForm, message: "Custom form updated successfully" });
  } catch (error) {
...
export async function deleteForm(req, res) {
  ...
  try {
    ...
    await prisma.customForm.delete({ where: { id: formId } });

    return res.json({ success: true, message: "Custom form deleted successfully" });
  } catch (error) {
...
export async function createFunnel(req, res) {
  ...
  try {
    ...
    return res.json({ success: true, funnel, message: "Conversion funnel created successfully" });
  } catch (error) {
...
export async function updateFunnel(req, res) {
  ...
  try {
    ...
    return res.json({ success: true, funnel: updatedFunnel, message: "Conversion funnel updated successfully" });
  } catch (error) {
...
export async function deleteFunnel(req, res) {
  ...
  try {
    ...
    await prisma.conversionFunnel.delete({ where: { id: funnelId } });

    return res.json({ success: true, message: "Conversion funnel deleted successfully" });
  } catch (error) {
